"""ML validated pipeline definition."""
...
def create_pipeline(**kwargs) -> Pipeline:
    """Create ML validated pipeline with namespace."""
    ...
    base_pipeline = pipeline([
        ...
        node(
            ...
            inputs=["train_data", "val_data", "params:ml_validator"],
            outputs="trained_validator",
            name="train_sklearn_validator",
            tags=["model_training", "sklearn"],
        ),
